...
namespace OscSimpl
{
	...
	public class OscOutInspector : Editor
	{
		...
		SerializedProperty _bundleMessagesAutomatically;
		...
		void OnEnable()
		{
			...
			_bundleMessagesAutomatically = serializedObject.FindProperty( "_bundleMessagesAutomatically" );
		...
		public override void OnInspectorGUI()
		{
			...
			if( _settingsFoldout.boolValue )
			{
				...
				EditorGUILayout.PropertyField( _bundleMessagesAutomatically, _bundleMessagesAutomaticallyLabel );
				if( !_bundleMessagesAutomatically.boolValue ) {
